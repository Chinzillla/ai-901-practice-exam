...
## Unit 4 Question Bank: Foundry Tools
...
### 1. A solution needs to transcribe spoken prompts. Which Foundry Tool area applies?
...
### 2. What is the main purpose of "Foundry Tools"?

A. tools for analyzing images and visual content  
B. tools for extracting information from documents and multimodal content  
C. Azure AI capabilities available for adding specialized functions to AI apps  
D. tools for speech recognition, synthesis, and related speech scenarios  

**Answer:** C  
**Rationale:** "Foundry Tools" is a core idea in this unit, and the correct option paraphrases its role.
...
### 4. How should a developer choose among Foundry Tools?

A. Match the tool to the input type and task, such as speech, vision, text, or extraction.  
B. Choose the first tool alphabetically.  
C. Use Speech for every image and document task.  
D. Avoid tools when a solution needs external capabilities.  
...
E. Extract information from forms  
