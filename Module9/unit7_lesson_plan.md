...
[Microsoft Learn unit](https://learn.microsoft.com/en-us/training/modules/foundry-sdk/07-knowledge-check)

### Unit Overview

This assessment-prep unit reviews Foundry chat app development concepts with original questions about endpoints, SDKs, APIs, and secure authentication.

### Learning Objectives

- review endpoint choices
- compare SDK roles
- distinguish Responses and ChatCompletions APIs
- identify secure authentication practices

### Key Terms

| Term | Beginner-Friendly Definition |
| --- | --- |
| Endpoint choice | The decision about which service URL and capability surface the app should use. |
| Project feature | A Foundry capability such as tracing, connections, evaluations, agents, or datasets. |
| Inference | Calling a deployed model to generate output. |
| Secure secret handling | Protecting credentials rather than exposing them in source code. |

### Lesson Flow

#### 1. Review

- Project endpoints and SDKs support broader Foundry features.
- OpenAI-compatible APIs support model inference patterns.
- Authentication should be secure and suitable for production.

#### 2. Common mistakes

- Learners often confuse SDK selection with model selection.
- Learners should separate playground exploration from production readiness.
